...
function addStock(){
    if (document.getElementById("product_name").value.trim() === "" || document.getElementById("sales_price").value.trim() === "" || document.getElementById("quantity").value.trim() === "" || document.getElementById("mrp").value.trim() === ""){
        alert("Product, MRP, Sales price, Quantity cannot be empty.");
        return;
    }
